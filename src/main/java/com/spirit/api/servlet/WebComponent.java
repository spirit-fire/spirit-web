...
//                request.getInputStream());
        ...
        try {
            ...
            final WebComponent.Writer w = new WebComponent.Writer(useSetStatusOn404, response);
    ...
    protected void configure(WebConfig wc, ResourceConfig rc, WebApplication wa) {
        ...
        rc.getSingletons().add(new WebComponent.ContextInjectableProvider<HttpServletRequest>(
        ...
        rc.getSingletons().add(new WebComponent.ContextInjectableProvider<HttpServletResponse>(
        ...
        rc.getSingletons().add(new WebComponent.ContextInjectableProvider<ThreadLocal<HttpServletRequest>>(
        ...
        rc.getSingletons().add(new WebComponent.ContextInjectableProvider<ThreadLocal<HttpServletResponse>>(
                responseThreadLocal.getType(), responseThreadLocal.getEntity()));

        rc.getSingletons().add(new WebComponent.ContextInjectableProvider<ServletContext>(
                ServletContext.class,
                wc.getServletContext()));

        rc.getSingletons().add(new WebComponent.ContextInjectableProvider<WebConfig>(
                WebConfig.class,
                wc));
